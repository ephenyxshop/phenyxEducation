...
class ConfigurationTestCore {
     ...
     * @var array $testFiles
     *
     * @since 1.9.1.0 Renamed from $test_files
     */
    ...
    public static function getDefaultTests() {
        ...
        $tests = [
            ...
            'ImgDir'                  => 'img',
            'ModuleDir'               => 'modules',
            'ThemeLangDir'            => 'frontShop/' . _THEME_NAME_ . '/lang/',
            'ThemePdfLangDir'         => 'frontShop/' . _THEME_NAME_ . '/pdf/lang/',
            'ThemeCacheDir'           => 'frontShop/' . _THEME_NAME_ . '/cache/',
     ...
     * @return bool
     *
     * @since 1.9.1.0 Added $absolute parameter
     * @version 1.8.1.0 Initial version
     */
