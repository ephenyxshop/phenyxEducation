...
class PhenyxShopAutoload {
    ...
    public function generateIndex() {
        ...
        $classes = array_merge(
            $this->getClassesFromDir('app/classes/'),
            $this->getClassesFromDir('app/controllers/'),
            $this->getClassesFromDir('vendor/ephenyxshop/phenyxeducation/lib/Adapter/'),
            $this->getClassesFromDir('vendor/ephenyxshop/phenyxeducation/lib/Core/')
        );
