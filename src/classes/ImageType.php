...
class ImageTypeCore extends ObjectModel {
    ...
    const SINGULAR_DIR = [
        ...
        'users'     => ['dir' => _PS_EMPLOYEE_IMG_DIR_, 'iterate' => false],
    ...
    public static $definition = [
        ...
        'fields'  => [
            ...
            'education' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
            'users'     => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
        ],
    ];
    ...
    public static function getByNameNType($name, $type = null, $order = 0) {
        ...
        if (!isset(static::$images_types_name_cache[$name . '_' . $type . '_' . $order]) && !$isPassed) {
            ...
            $types = ['products', 'categories', 'manufacturers', 'suppliers', 'scenes', 'stores', 'education'];
            $total = count($types);
