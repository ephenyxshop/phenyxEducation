...
abstract class ObjectModelCore implements Core_Foundation_Database_EntityInterface {
     ...
     * These magic methods provide backwards compatibility for modules/frontShop/whatevers
    ...
    public function update($nullValues = false) {
        ...
        if (Shop::isTableAssociated($this->def['table'])) {
            ...
            foreach ($idShopList as $idShop) {
                ...
                if ($shopExists) {
                    // Unset fields from other shops when in single shop context
    ...
    public function getWebserviceParameters($wsParamsAttributeName = null) {
        ...
        if (!isset($this->{$wsParamsAttributeName}
        ...
        if (isset($this->{$wsParamsAttributeName}
            ...
            foreach ($this->{$wsParamsAttributeName}

                ['associations'] as $assocName => &$association) {
        ...
        if (isset($this->{$wsParamsAttributeName}
            ...
            ['retrieveData']) && isset($this->{$wsParamsAttributeName}

            ['retrieveData']['retrieveMethod'])) {
