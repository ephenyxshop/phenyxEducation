...
?>'
    ...
    public static function getFilesList($isoFrom, $themeFrom, $isoTo = false, $themeTo = false, $select = false, $check = false, $modules = false) {
        ...
        $tPathFrom = _PS_ROOT_DIR_ . '/frontShop/' . (string) $themeFrom . '/';
        $pPathFrom = _PS_ROOT_DIR_ . '/frontShop/' . (string) $themeFrom . '/pdf/';
        $mPathFrom = _PS_MAIL_DIR_ . (string) $isoFrom . '/';

        if ($copy) {
            $lPathTo = _PS_TRANSLATIONS_DIR_ . (string) $isoTo . '/';
            $tPathTo = _PS_ROOT_DIR_ . '/frontShop/' . (string) $themeTo . '/';
            $pPathTo = _PS_ROOT_DIR_ . '/frontShop/' . (string) $themeTo . '/pdf/';
