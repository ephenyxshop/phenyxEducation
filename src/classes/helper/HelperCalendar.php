...
class HelperCalendarCore extends Helper {
    ...
    public function generate() {
        ...
        if ($context->controller->ajax) {
            $html = '<script type="text/javascript" src="' . __PS_BASE_URI__ . $adminWebpath . '/js/date-range-picker.js"></script>';
            $html .= '<script type="text/javascript" src="' . __PS_BASE_URI__ . $adminWebpath . '/js/calendar.js"></script>';
        } else {
            $html = '';
