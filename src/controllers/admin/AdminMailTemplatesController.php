...
class AdminMailTemplatesControllerCore extends AdminController {
    ...
    public function initContent() {
        ...
        $this->TitleBar = $this->l('Liste des modèles de mail');

        $this->context->smarty->assign([
            'controller'     => Tools::getValue('controller'),
            'tabScript'      => $this->generateTabScript(Tools::getValue('controller')),
            'gridId'         => 'grid_AdminMailTemplates',
    ...
    public function ajaxProcessScanDirectoryMail() {
		...
		$iterator->append(new DirectoryIterator(_PS_ROOT_DIR_ . '/mails/fr'));
	...
	public function ajaxProcessDeleteTemplate() {
		...
		$filePath = _PS_ROOT_DIR_.'/mails/fr/'.$template->template;
    ...
    public function ajaxProcessUpdateMailTemplate() {
        ...
        $file = fopen(_PS_ROOT_DIR_ . "/mails/fr/" . $mailTemplate->template, "w");
        fwrite($file, $output);
