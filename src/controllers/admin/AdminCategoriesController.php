...
class AdminCategoriesControllerCore extends AdminController {
    ...
    public function __construct() {
        ...
        $this->extracss = $this->pushCSS([
            $this->admin_webpath . '/themes/' . $this->bo_theme . '/css/categories.css',
    ...
    public function setAjaxMedia() {
        ...
        return $this->pushJS([
            ...
            $this->admin_webpath . '/js/categories.js',
    ...
    public function generateParaGridScript() {
        ...
        $paragrid->height = 700;
        //$paragrid->recIndx = ''.$this->identifier.'';
        ...
        $paragrid->title = '\'' . $this->l('Géstion des Familles de Produits') . '\'';
    ...
    public function getCategoryRequest() {
        ...
        foreach ($results as &$category) {
            ...
            if ($category['active'] == 1) {
                $category['active'] = '<div class="p-active"></div>';
                $category['enable'] = true;
            } else {
                $category['active'] = '<div class="p-inactive"></div>';
                $category['enable'] = false;
            }

            $category['description'] = $this->recurseShortCode($category['description']);
    ...
    public function init() {
        ...
        if (!Shop::isFeatureActive() && $countCategoriesWithoutParent > 1) {
        ...
        if (Shop::isFeatureActive() && $countCategoriesWithoutParent > 1 && Shop::getContext() != Shop::CONTEXT_SHOP) {
    ...
    public function ajaxProcessAddNewCategory() {
        ...
        $html = $scripHeader . $this->renderForm() . $scriptFooter;
        $result = [
            'success' => true,
            'html'    => $html,
        ];
    ...
    public function renderForm() {
        ...
        if ($obj->id > 0) {
            $this->fields_value['action'] = 'updateCategory';
        } else {
            $this->fields_value['action'] = 'addCategory';
        }
