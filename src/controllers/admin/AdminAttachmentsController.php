...
class AdminAttachmentsControllerCore extends AdminController {
    ...
    public function setMedia() {
        ...
        $this->addJs(__PS_BASE_URI__ . $this->admin_webpath . '/js/attachments.js');
        MediaAdmin::addJsDefL('confirm_text', $this->l('This attachment is associated with the following products, do you really want to  delete it?', null, true, false));
    }
