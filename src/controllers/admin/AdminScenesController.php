...
class AdminScenesControllerCore extends AdminController
{
    ...
    public function initFieldsForm()
    {
        ...
        if ($obj->id && file_exists(_PS_SCENE_IMG_DIR_.$obj->id.'-scene_default.jpg')) {
            ...
            $this->addJs(__PS_BASE_URI__.$this->admin_webpath.'/js/scenes.js');
    ...
    protected function afterImageUpload()
    {
        ...
        if ($obj->id && (isset($_FILES['image']) || isset($_FILES['thumb']))) {
            ...
            if ((int) Configuration::get('EPH_IMAGES_LAST_UPD_SCENES') < $obj->id) {
                Configuration::updateValue('EPH_IMAGES_LAST_UPD_SCENES', $obj->id);
            }
        }
