...
class AdminGroupsControllerCore extends AdminController {
    ...
    public function setMedia() {
		...
		MediaAdmin::addJsDef([
            'AjaxLinkAdminGroups' => $this->context->link->getAdminLink($this->controller_name)
            
        ]);
		$this->addCSS(__PS_BASE_URI__ . $this->admin_webpath . '/themes/' . $this->bo_theme . '/css/groups.css', 'all', 0);
    ...
    public function initContent() {
		...
		$this->TitleBar = $this->l('Groups List');
