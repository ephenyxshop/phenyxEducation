...
class AdminDashboardControllerCore extends AdminController {
	...
	public function setMedia() {
		...
		$this->addCSS(
			[
				...
				_PS_ADMIN_DIR_ . '/themes/' . $this->bo_theme . '/css/dashboard.css',
				_PS_ADMIN_DIR_ . '/themes/' . $this->bo_theme . '/css/member.css',
			]
		);
		...
		$this->addJS(
			[
				...
				_PS_ADMIN_DIR_ . '/js/nav.js',
				__PS_BASE_URI__ . $this->admin_webpath . '/js/dashactivity.js',
            	_PS_ADMIN_DIR_ . '/js/datejs/date.min.js',
				_PS_JS_DIR_ . 'tools.js',
				__PS_BASE_URI__ . $this->admin_webpath . '/js/dashtrends.js',
				_PS_JS_DIR_ . 'vendor/d3.v3.min.js',
				__PS_BASE_URI__ . $this->admin_webpath . '/themes/' . $this->bo_theme . '/js/vendor/nv.d3.min.js',
				__PS_BASE_URI__ . $this->admin_webpath . '/js/jquery.datetimepicker.full.js',
				__PS_BASE_URI__ . $this->admin_webpath . '/js/colorpicker/colorpicker.js',
				__PS_BASE_URI__ . $this->admin_webpath . '/js/dashboard.js',
				__PS_BASE_URI__ . $this->admin_webpath . '/js/tabs.js',

			]
		);
		$this->addCSS(__PS_BASE_URI__ . $this->admin_webpath . '/themes/' . $this->bo_theme . '/css/vendor/nv.d3.css');
		$this->addCSS(__PS_BASE_URI__ . $this->admin_webpath . '/themes/' . $this->bo_theme . '/css/mainboard.css');
		$this->addCSS(__PS_BASE_URI__ . $this->admin_webpath . '/themes/' . $this->bo_theme . '/css/colorpicker/colorpicker.css');
		$this->addCSS(__PS_BASE_URI__ . $this->admin_webpath . '/themes/' . $this->bo_theme . '/css/jquery.datetimepicker.css');
		MediaAdmin::addJsDef([
			'AjaxLinkAdminTopbars'   => $this->context->link->getAdminLink('AdminTopbars'),
	...
	public function ajaxProcessOpenSociety() {
		...
		$pusjJs = $this->pushJS([
			$this->admin_webpath . '/js/society.js',
	...
	public function ajaxProcessGetFormatPackSuppliesFields() {
		...
		$fields = [
			...
			[
				'title'    => $this->l('Quantité Facturées'),
				'maxWidth' => 150,
				'dataIndx' => 'sold',
				'align'    => 'right',
				'valign'   => 'center',
			...
			[
				'title'    => $this->l('Stock Prévisionnel'),
