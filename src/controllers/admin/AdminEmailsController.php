...
class AdminEmailsControllerCore extends AdminController {
    ...
    public function setMedia() {
        ...
        $this->addJs(__PS_BASE_URI__ . $this->admin_webpath . '/js/email.js');

        MediaAdmin::addJsDefL('textMsg', $this->l('This is a test message. Your server is now configured to send email.', null, true, false));
        MediaAdmin::addJsDefL('textSubject', $this->l('Test message -- ephenyx', null, true, false));
        MediaAdmin::addJsDefL('textSendOk', $this->l('A test email has been sent to the email address you provided.', null, true, false));
        MediaAdmin::addJsDefL('textSendError', $this->l('Error: Please check your configuration', null, true, false));
        MediaAdmin::addJsDefL('token_mail', $this->token);
        MediaAdmin::addJsDefL('errorMail', $this->l('This email address is not valid', null, true, false));
    }
