...
class AdminCompanyControllerCore extends AdminController {
    ...
    public function setMedia() {
        ...
        $this->addJS(__PS_BASE_URI__ . $this->admin_webpath . '/js/company.js');
        $this->addCSS(__PS_BASE_URI__ . $this->admin_webpath . '/themes/' . $this->bo_theme . '/css/company.css', 'all', 0);
        MediaAdmin::addJsDef([
    ...
    public function initContent() {
        ...
        $this->context->smarty->assign([
            ...
            'titleBar'        => $this->TitleBar, dmin_webpath . '/themes/' . $this->bo_theme . '/img/',
