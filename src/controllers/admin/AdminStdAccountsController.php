...
class AdminStdAccountsControllerCore extends AdminController {
    ...
    public function setMedia() {
        ...
        $this->addCSS(__PS_BASE_URI__ . $this->admin_webpath . '/themes/' . $this->bo_theme . '/css/account.css', 'all');
        $this->addJS(__PS_BASE_URI__ . $this->admin_webpath . '/js/stdaccount.js');
	...
	public function setAjaxMedia() {
		...
		return $this->pushJS([
			$this->admin_webpath . '/js/stdaccount.js',
		]);
	}
	...
	public function ajaxProcessOpenTargetController() {
		...
		$extracss = $this->pushCSS([
			$this->admin_webpath . '/themes/' . $this->bo_theme . '/css/account.css',
