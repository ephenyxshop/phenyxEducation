...
class AdminAddressesControllerCore extends AdminController {
	...
	public function setMedia() {
		...
		MediaAdmin::addJsDef([
			'AjaxLinkAdminAddresses' => $this->context->link->getAdminLink($this->controller_name),
			'AjaxLinkAdminStates'    => $this->context->link->getAdminLink('AdminStates'),

		]);
		//$this->addCSS(__PS_BASE_URI__ . $this->admin_webpath . '/themes/' . $this->bo_theme . '/css/customer.css', 'all', 0);
	...
	public function initContent() {
		...
		$this->TitleBar = $this->l('Addresses List');
