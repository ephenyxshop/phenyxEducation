...
class AdminCmsContentControllerCore extends AdminController {
	...
	public function setAjaxMedia() {
		...
		return $this->pushJS([
			$this->admin_webpath . '/js/cmsCategory.js',
	...
	public function ajaxProcessOpenTargetController() {
		...
		$data = $this->createTemplate('controllers/cmscontent.tpl');
		...
		foreach ($cmsCategories as $category) {
			...
			$paragrid->paragrid_option['paragrids'][] = [
        		...
        		return {
            		...
            		items: {
						"add": {
							name: \'' . $this->l('Ajouter une Page CMS') . '\',
							icon: "add",
                		...
                		"edit": {
							name: \'' . $this->l('Edit the cms page') . ' :\'+rowData.meta_title,
							icon: "edit",
                			callback: function(itemKey, opt, e) {
						...
						"sep1": "---------",
           				"delete": {
           					name: \'' . $this->l('Delete the cms page') . ' :\'+rowData.meta_title,
           					icon: "delete",
