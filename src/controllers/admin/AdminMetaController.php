...
class AdminMetaControllerCore extends AdminController {
    ...
    public function __construct() {
		...
		$this->extracss = $this->pushCSS([
			...
			$this->admin_webpath . '/themes/' . $this->bo_theme . '/css/metas.css',
    ...
    public function setMedia() {
        ...
        $this->addJS(_PS_JS_ADMIN_DIR_ . 'metas.js');
        $this->addJS(_PS_JS_ADMIN_DIR_ . 'ace/ace.js');
        $this->addJS(_PS_JS_ADMIN_DIR_ . 'ace/ext-language_tools.js');
        $this->addJS(_PS_JS_ADMIN_DIR_ . 'ace/snippets/text.js');
        $this->addJS(_PS_JS_ADMIN_DIR_ . 'ace/snippets/apache_conf.js');
        $this->addCSS(_PS_JS_ADMIN_DIR_ . 'ace/aceinput.css');
        MediaAdmin::addJsDef([
	...
	public function setAjaxMedia() {
		...
		return $this->pushJS([
			$this->admin_webpath . '/js/metas.js',
			$this->admin_webpath . '/js/jquery/plugins/jquery.tagify.js',
			$this->admin_webpath . '/js/ace/ace.js',
			$this->admin_webpath . '/js/ace/ext-language_tools.js',
			$this->admin_webpath . '/js/ace/snippets/text.js',
			$this->admin_webpath . '/js/ace/snippets/apache_conf.js',
		]);
	}
    ...
    public function addAllRouteFields() {
        ...
        $this->addFieldRoute('education_rule', $this->l('Route to products'));
        ...
        $this->addFieldRoute('education_type_rule', $this->l('Route pour les familles de formation'));
        $this->addFieldRoute('education_rule', $this->l('Route pour les formations'));
        $this->addFieldRoute('cms_rule', $this->l('Route to CMS page'));
        $this->addFieldRoute('cms_category_rule', $this->l('Route to CMS category'));
		$this->addFieldRoute('pfg_rule', $this->l('Route des formulaires'));
		$this->addFieldRoute('sponsor_rule', $this->l('Route des sponsors'));
    }
