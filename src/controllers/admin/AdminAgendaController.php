...
class AdminAgendaControllerCore extends AdminController {
    ...
    public function __construct() {
        ...
        $this->extracss = $this->pushCSS([
            _PS_ADMIN_DIR_ . '/js/calendar/bootstrap.min.css',
            _PS_ADMIN_DIR_ . '/js/trumbowyg/ui/trumbowyg.min.css',
            _PS_ADMIN_DIR_ . '/js/select2/select2.min.css',
            _PS_ADMIN_DIR_ . '/themes/' . $this->bo_theme . '/css/calendar/backend.min.css',
            _PS_ADMIN_DIR_ . '/themes/' . $this->bo_theme . '/css/calendar/general.css',
            _PS_ADMIN_DIR_ . '/js/jquery-fullcalendar/fullcalendar.min.css',
        ]);
    }
    ...
    public function setAjaxMedia() {
        ...
        return $this->pushJS([
            _PS_ADMIN_DIR_ . '/themes/' . $this->bo_theme . '/css/calendar/bootstrap/js/bootstrap.bundle.min.js',
            _PS_ADMIN_DIR_ . '/js/popper/popper.min.js',
            _PS_ADMIN_DIR_ . '/js/tippy/tippy-bundle.umd.min.js',
            _PS_ADMIN_DIR_ . '/js/jquery-ui/jquery-ui.touch-punch.min.js',
            _PS_ADMIN_DIR_ . '/js/moment/moment.min.js',
            _PS_ADMIN_DIR_ . '/js/moment/moment-timezone-with-data.min.js',
            _PS_ADMIN_DIR_ . '/js/datejs/date.min.js',
            _PS_ADMIN_DIR_ . '/js/trumbowyg/trumbowyg.min.js',
            _PS_ADMIN_DIR_ . '/js/select2/select2.min.js',
            _PS_ADMIN_DIR_ . '/js/jquery-fullcalendar/fullcalendar.min.js',
            _PS_ADMIN_DIR_ . '/js/jquery-jeditable/jquery.jeditable.min.js',
            _PS_ADMIN_DIR_ . '/js/jquery-ui/jquery-ui-timepicker-addon.min.js',
            _PS_ADMIN_DIR_ . '/js/calendar/working_plan_exceptions_modal.min.js',
            _PS_ADMIN_DIR_ . '/js/calendar/backend_calendar.min.js',
            _PS_ADMIN_DIR_ . '/js/calendar/backend_calendar_default_view.min.js',
            _PS_ADMIN_DIR_ . '/js/calendar/backend_calendar_table_view.min.js',
            _PS_ADMIN_DIR_ . '/js/calendar/backend_calendar_google_sync.min.js',
            _PS_ADMIN_DIR_ . '/js/calendar/backend_calendar_appointments_modal.min.js',
            _PS_ADMIN_DIR_ . '/js/calendar/backend_calendar_unavailability_events_modal.min.js',
            _PS_ADMIN_DIR_ . '/js/calendar/backend_calendar_api.min.js',
            _PS_ADMIN_DIR_ . '/js/calendar/backend.min.js',
            _PS_ADMIN_DIR_ . '/js/calendar/polyfill.min.js',
            _PS_ADMIN_DIR_ . '/js/calendar/general_functions.min.js',
        ]);
    }
    ...
    public function ajaxProcessOpenTargetController() {
        ...
        $data = $this->createTemplate('controllers/calendar.tpl');
