		...
		foreach ($this->fields as $field)
		{
			...
			else
			{
				if (is_array($entry[$field['name']]))
				{
					...
					foreach ($entry[$field['name']] as $element)
					{
						if ($element === 'true') $element = $this->l('Yes');
						else if ($element === 'false') $element = $this->l('No');
				...
				{
					if ($entry[$field['name']] === 'true') $entry[$field['name']] = $this->l('Yes');
					else if ($entry[$field['name']] === 'false') $entry[$field['name']] = $this->l('No');
