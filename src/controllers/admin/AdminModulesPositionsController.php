...
class AdminModulesPositionsControllerCore extends AdminController {
	...
	public function setAjaxMedia() {
		...
		return $this->pushJS([
			$this->admin_webpath . '/js/jquery/plugins/select2/jquery.select2.js',
			$this->admin_webpath . '/js/jquery/plugins/select2/select2_locale_fr.js',
			$this->admin_webpath . '/js/modules-position.js',                       
			$this->admin_webpath . '/js/jquery/plugins/jquery.sortable.js',
			$this->admin_webpath . '/js/jquery/plugins/jquery.tablednd.js',
		]);
	}
    ...
    public function postProcess() {
        ...
        $this->addJS(
            [
                __PS_BASE_URI__ . $this->admin_webpath . '/js/modules-position.js',
                __PS_BASE_URI__ . $this->admin_webpath . '/js/jquery/plugins/select2/select2_locale_' . $this->context->language->iso_code . '.js',
            ]
        );
