...
class AdminBackUsersControllerCore extends AdminController {
    ...
    public function setMedia() {
        ...
        parent::setMedia();
        $this->addJS(__PS_BASE_URI__ . $this->admin_webpath . '/js/employee.js');
        MediaAdmin::addJsDef([
    ...
    public function ajaxProcessAddObject() {
		...
		$pusjJs = $this->pushJS([
            $this->admin_webpath . '/js/employee.js',
		...
		$imageUrl = 'img/e/' . $employee->id . '.jpg';
    ...
    public function ajaxProcessUpdateObject() {
		...
		if($result) {
            ...
            $result = [
            	'success' => true,
                'message' => $object->firstane.' '.$object->lastname.$this->l(' a été mis à jour avec succès'),
			];
    ...
    public function ajaxProcessAddNewAjaxObject() {
        ...
        if($result) {
            ...
            $result = [
            	'success' => true,
                'message' => $object->firstane.' '.$object->lastname.$this->l(' a été ajouté avec succès'),
			];
