...
class AdminAttributeContentControllerCore extends AdminController {
	...
	public function setMedia() {
		...
		$this->addJS([
			...
			//    __PS_BASE_URI__ . $this->admin_webpath . '/js/attribute.js',
		]);

		$this->addJqueryPlugin('tagify');
		MediaAdmin::addJsDef([
			'AjaxLink' . $this->admin_attribute_group->controller_name => $this->context->link->getAdminLink($this->admin_attribute_group->controller_name),
			'AjaxLink' . $this->controller_name                        => $this->context->link->getAdminLink($this->controller_name),

		]);
		$this->addJS([
			__PS_BASE_URI__ . $this->admin_webpath . '/js/attributeGroup.js',
		]);
	}
	...
	public function setAjaxMedia() {
		...
		return $this->pushJS([
			$this->admin_webpath . '/js/attributeGroup.js',
		]);
	}
	...
	public function initContent() {
		...
		$this->context->smarty->assign([
			...
			'idController'    => '',
			'attributeGridId' => $this->attributeGridId,
		]);
