...
class PhenyxShopAutoload {
    ...
    public function generateIndex() {
        ...
        $classes = array_merge(
            $this->getClassesFromDir(dirname(__FILE__) . '/classes/'),
            $this->getClassesFromDir(dirname(__FILE__) . '/controllers/'),
			$this->getClassesFromDir(dirname(__FILE__) .'../lib/Adapter/'),
            $this->getClassesFromDir(dirname(__FILE__) .'../lib/Core/')
        );
...
spl_autoload_register([PhenyxShopAutoload::getInstance(), 'load']);