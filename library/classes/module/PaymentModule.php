...
abstract class PaymentModuleCore extends Module {
    ...
    public function addCheckboxCurrencyRestrictionsForModule(array $companys = []) {
    ...
    public function addRadioCurrencyRestrictionsForModule(array $companys = []) {
    ...
    public function addCheckboxCountryRestrictionsForModule(array $companys = []) {
        ...
        return Country::addModuleRestrictions($companys, $countries, [['id_module' => (int) $this->id]]);
    }

    public function validateOrder($id_cart, $id_order_state, $amount_paid, $payment_method = 'Unknown',
        $message = null, $extra_vars = [], $currency_special = null, $dont_touch_amount = false,
        $secure_key = false, Company $company= null) {
