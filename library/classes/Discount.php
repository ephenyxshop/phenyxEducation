...
class DiscountCore extends CartRule {
     ...
     * @throws PhenyxShopException
     */
    public function getValue($nb_discounts = 0, $order_total_products = 0, $shipping_fees = 0, $idCart = false, $useTax = true, Currency $currency = null, Shop $company= null) {
    ...
    public static function createOrderDiscount($order, $productList, $qtyList, $name, $shippingCost = false, $idCategory = 0, $subcategory = 0) {
        ...
        foreach ($discounts as $discount) {
            ...
            } else if ($discount['id_discount_type'] == Discount::AMOUNT) {
