...
class AddressCore extends PhenyxObjectModel {
    ...
    public static $definition = [
        ...
        'fields'  => [
			...
			'id_agent'     => ['type' => self::TYPE_INT, 'validate' => 'isNullOrUnsignedId', 'copy_post' => false],
			'id_student'     => ['type' => self::TYPE_INT, 'validate' => 'isNullOrUnsignedId', 'copy_post' => false],
