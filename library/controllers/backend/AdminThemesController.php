...
class AdminThemesControllerCore extends AdminController {
    ...
    public function __construct() {
        ...
        $this->publicName = $this->la('Thème front office');
    ...
    public function renderTabTheme() {
        ...
        $this->fields_form = [
            ...
            'input'   => [
                [
                    'type'        => 'switch',
                    'label'       => $this->la('Afficher le logo Qualiopi'),
                    'name'        => 'EPH_HOME_QUALIOPI_ACTIVE',
                    'desc'        => $this->la('Si activé, le logo Qualiopi s‘affichera en front office.'),
                    'class'       => 't',
                    'is_bool'     => true,
                    'default_val' => '1',
                    'values'      => [
                        [
                            'id'      => 'EPH_HOME_QUALIOPI_ACTIVE_on',
                            'value'   => 1,
                            'label_1' => $this->la('Oui'),
                        ],
                        [
                            'id'      => 'EPH_HOME_QUALIOPI_ACTIVE_off',
                            'value'   => 0,
                            'label_0' => $this->la('Non'),
                        ],
                    ],
                ...
                [
                    'type'        => 'switch',
                    'label'       => $this->la('Utiliser le mode Polygone'),
                    'name'        => 'EPH_POLYGON_ACTIVE',
                    'desc'        => $this->la('Si activé, le site passera en mode polygone Alex trade mark.'),
                    'class'       => 't',
                    'is_bool'     => true,
                    'default_val' => '1',
                    'values'      => [
                ...
                [
                    'type'        => 'switch',
                    'label'       => $this->la('Afficher le slider en page d‘acceuil'),
                    'name'        => 'EPH_HOME_SLIDER_ACTIVE',
                    'desc'        => $this->la('Si activé, affiche le slider en page d‘acceuil en front office.'),
                    'class'       => 't',
                    'is_bool'     => true,
                    'default_val' => '1',
                    'values'      => [
                ...
                [
                    'type'        => 'switch',
                    'label'       => $this->la('Afficher une video en page d‘acceuil'),
                    'name'        => 'EPH_HOME_VIDEO_ACTIVE',
                    'desc'        => $this->la('Si activé, affiche une Vidéo en page d‘acceuil en front office.'),
                    'class'       => 't',
                    'is_bool'     => true,
                    'default_val' => '1',
                    'values'      => [
                ...
                [
                    'type'  => 'text',
                    'label' => $this->la('Lien de la Video'),
                    'name'  => 'EPH_HOME_VIDEO_LINK',
                    'desc'  => $this->la('Lien de la Vidéo, youtube, vimeo ex https://vimeo.com/xxxx...'),
                ],
                [
                    'type'        => 'switch',
                    'label'       => $this->la('Afficher une image en Parallax en page d‘acceuil'),
                    'name'        => 'EPH_HOME_PARALLAX_ACTIVE',
                    'desc'        => $this->la('Si activé, affiche une image en Parallax en page d‘acceuil en front office.'),
                    'class'       => 't',
                    'is_bool'     => true,
                    'default_val' => '1',
                    'values'      => [
                ...
                [
                    'type'  => 'upload_img',
                    'label' => $this->la('Prévisualisation de l‘image'),
                    'name'  => 'parallaxImage',
                ],
	...
	public function renderBodyStyleForm() {
        ...
        $fields_forms['body'] = [
            'tinymce' => true,
            'legend'  => [
                'title' => $this->la('Le Body'),
            ],
            'id_form' => 'theme_body_style',
            'input'   => [
                [
                    'type'       => 'infoheading',
                    'label'      => $this->la('Paramètres Globales :'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
                [
                    'type'       => 'googlefont',
                    'label'      => $this->la('Police générale (body)'),
                    'name'       => 'bodyfont',
                    'colorclass' => 'success',
                ],
                [
                    'type'        => 'select_font_size',
                    'label'       => $this->la('Taille de la Police du Site'),
                    'name'        => 'body_f_size',
                    'default_val' => '13',
                    'size'        => 10,
                    'required'    => true,
                ...
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur de la Police du Site'),
                    'name'        => 'body_f_color',
                ...
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur du Background du Site'),
                    'name'        => 'body_bg_color',
                ...
                [
                    'type'          => 'select',
                    'label'         => $this->la('Utiliser une image pour le Background du site'),
                    'name'          => 'enable_body_bg',
                ...
                [
                    ...
                    'label'            => $this->la('Select Background Image'),
                    'desc'             => $this->la('Select body background Image'),
                    'name'             => 'body_bg_image',
                    'default_val'      => '',
                ],
                [
                    'type'             => 'bg_pattern',
                    'form_group_class' => 'enable_body_bg_on',
                    'label'            => $this->la('Select Background Pattern'),
                    'desc'             => $this->la('Select body background pattern'),
                    'name'             => 'body_bg_pattern',
                    'default_val'      => '',
                ],
                [
                    'type'             => 'select',
                    'form_group_class' => 'enable_body_bg_on',
                    'label'            => $this->la('Body background repeat'),
                    'name'             => 'body_bg_repeat',
                    'default_val'      => 'repeat',
                    'desc'             => $this->la('Select body background repeat/no-repeat'),
                    'options'          => [
                        'id'    => 'id',
                        'name'  => 'name',
                        'query' => [
                ...
                [
                    'type'             => 'background_position',
                    'form_group_class' => 'enable_body_bg_on',
                    'label'            => $this->la('Body background position'),
                    'name'             => 'body_bg_position',
                    'desc'             => $this->la('Select body background position'),                    
                ],
                [
                    'type'             => 'select',
                    'form_group_class' => 'enable_body_bg_on',
                    'label'            => $this->la('Body background size'),
                    'name'             => 'body_bg_size',
                    'default_val'      => 'initial',
                    'desc'             => $this->la('Select body background size'),
                    'options'          => [
                        'id'    => 'id',
                        'name'  => 'name',
                        'query' => [
                ...
                [
                    'type'             => 'select',
                    'form_group_class' => 'enable_body_bg_on',
                    'label'            => $this->la('Body background attachment'),
                    'name'             => 'body_bg_attachment',
                    'default_val'      => 'scroll',
                    'desc'             => $this->la('Select body background attachment'),
                    'options'          => [
                        'id'    => 'id',
                        'name'  => 'name',
                        'query' => [
                ...
                [
                    'type'       => 'infoheading',
                    'label'      => $this->la('Paramètres De la Page :'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
                [
                ...
                [
                    'type'       => 'infoheading',
                    'label'      => $this->la('Paramètres du Corps :'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
                [
                    'type'        => 'select',
                    'label'       => $this->la('Conteneur du Corps de la Page'),
                    'name'        => 'body_page_style',

                    'default_val' => 'full_width',
                    'desc'        => $this->la('Choississez le style de largeur. (Fonctionne avec le Header Simple)'),
                    'options'     => [
                        'id'    => 'id',
                        'name'  => 'name',
                        'query' => [
                ...
                [
                    'type'        => 'select',
                    'label'       => $this->la('Page container width'),
                    'name'        => 'body_boxed_width',
                    'default_val' => '1170',
                    'desc'        => $this->la('Select page container width. (Works with Header Simple style Black)'),
                    'options'     => [
                        'id'    => 'id',
                        'name'  => 'name',
                        'query' => [
                ...
                [
                    'type'        => 'margin',
                    'label'       => $this->la('Espacement extérieur du contener - margin (px)'),
                    'name'        => 'container_margin',
                    'default_val' => '0 0 0 0',
                ],
                [
                    'type'       => 'infoheading',
                    'label'      => $this->la('Police Additionelle :'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
                [
        ...
        $fields_forms['colors'] = [
            'legend'  => [
                'title' => $this->la('Réglages des Couleurs'),
            ],
            'id_form' => 'theme_color_link_style',
            'input'   => [
                [
                    'type'       => 'infoheading',
                    'label'      => $this->la('Les liens :'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur des Liens'),
                    'name'        => 'link_color',
                    'default_val' => '#666',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur des Liens Hover'),
                    'name'        => 'link_hvr_color',
                    'default_val' => '#000',
                ],
                [
                    'type'       => 'infoheading',
                    'label'      => $this->la('Les Titres & Labels :'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur des Titres'),
                    'name'        => 'title_color',
                    'default_val' => '#666',
                ],
                [
                    'type'        => 'googlefont',
                    'label'       => $this->la('Police des Titres'),
                    'name'        => 'title_font',
                    'default_val' => '#666',
                    'predefine'   => [
                ...
                [
                    'type'    => 'select',
                    'label'   => $this->la('Transformation du texte pour les titres'),
                    'name'    => 'title_font_transform',
                ...
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur des Labels'),
                    'name'        => 'label_color',
                    'default_val' => '#666',
                    'predefine'   => [
                ...
                [
                    'type'       => 'infoheading',
                    'label'      => $this->la('Couleurs Majeures :'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur Forte Princpale'),
                    'name'        => 'color_forte',
                    'default_val' => '#666',
                    'predefine'   => [
                ...
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur Forte Secondaire'),
                    'name'        => 'color_forte_second',
                    'default_val' => '#666',
                    'predefine'   => [
                ...
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur Forte Texte'),
                    'name'        => 'color_forte_text',
                    'default_val' => '#666',
                    'predefine'   => [
                ...
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur Forte Texte Secondaire'),
                    'name'        => 'color_forte_second_text',
                    'default_val' => '#666',
                    'predefine'   => [
		...
		$fields_forms['headerseetings'] = [
            ...
            'input'   => [
                ...
                [
                    'type'        => 'select_header',
                    'label'       => $this->la('Style du Header'),
                    'name'        => 'page_header_style',
                    'default_val' => 'header_style_full_boxed',

                    'desc'        => $this->la('Choisissez parmis différents style e header'),
                    'options'     => [
                        'id'    => 'id',
                        'name'  => 'name',
                        'query' => [
                ...
                [
                    'type'        => 'select',
                    'label'       => $this->la('Header width'),
                    'name'        => 'header_width',
                    'default_val' => '1170',
                    'desc'        => $this->la('Select Header width. (Works with Header Largeur Fixe)'),
                    'options'     => [
                        'id'    => 'id',
                        'name'  => 'name',
                        'query' => [
                ...
                [
                    'type'        => 'padding',
                    'label'       => $this->la('Espacement intérieur du Header- padding (px)'),
                    'name'        => 'header_padding',
                    'default_val' => '0 0 0 0',
                ],
                [
                    'type'        => 'margin',
                    'label'       => $this->la('Espacement extérieur du Header - margin (px)'),
                    'name'        => 'header_margin',
                    'default_val' => '0 0 0 0',
                ],
                [
                    'type'       => 'googlefont',
                    'label'      => $this->la('Police du Header'),
                    'name'       => 'headingfont',
                    'colorclass' => 'success',
                ],
                [
                    'type'  => 'height',
                    'label' => $this->la('Hauteur du Header'),
                    'desc'  => $this->la('Laisser vide pour auto'),
                    'name'  => 'header_height',
                ],
                [
                    'type'             => 'switch',
                    'label'            => $this->la('Comportement du Header'),
                    'name'             => 'header_fixed',
                    ...
                    'values'           => [
                        [
                            'id'      => 'header_fixed',
                            'value'   => 1,
                            'label_1' => $this->la('Fixe'),
                        ],
                        [
                            'id'      => 'header_fixed',
                            'value'   => 0,
                            'label_0' => $this->la('Relatif'),
                        ],
                    ],
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Background du Header'),
                    'name'        => 'header_bck_color',
                    'default_val' => '#000000',
                    'predefine'   => [
                    ],
				...
				[
                    'type'       => 'infoheading',
                    'label'      => $this->la('Header Conteneur'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
				[
                    'type'  => 'contener_position',
                    'label' => $this->la('Position du Brandline'),
					'form_group_id' => 'headerheader_contenerPosition',
                    'name'  => 'headerheader_position',
                ],
				[
                    'type'        => 'padding',
                    'label'       => $this->la('Espacement intérieur du Conteneur- padding (px)'),
                    'name'        => 'headerheader_padding',
                    'default_val' => '0 0 0 0',
                ],
                [
                    'type'        => 'margin',
                    'label'       => $this->la('Espacement extérieur du Conteneur - margin (px)'),
                    'name'        => 'headerheader_margin',
                ...
                [
                    'type'  => 'contener_border',
                    'label' => $this->la('Border du Brandline'),
                    'name'  => 'bandline_border',
                ],
		...
		$fields_forms['indexseetings'] = [
            ...
            'input'   => [
				 ...
				 [
                    'type'  => 'theme_manager',
                    'label' => $this->la('Gestion de l‘ordre des Widgets'),
                    'name'  => 'phenyxIndex_theme_manager',
					'templates' => [
						'bootsrap_index' =>  [							
							[
				 ...
				 [
                    'type'  => 'border_radius',
                    'label' => $this->la('Border Radius du tag phenyxIndex'),
                    'name'  => 'phenyxIndex_border_radius',
					'default_val' => '0 0 0 0',
                ],
				 [
                    'type'        => 'color',
                    'label'       => $this->la('Background du tag phenyxIndex'),
                    'name'        => 'phenyxIndex_bck_color',
                    'default_val' => 'transparent',
                ],
				[
                    'type'        => 'box_shadow',
                    'label'       => $this->la('Box Shadow'),
                    'name'        => 'phenyxIndex_box_shadow',					
                    'default_val' => '0 0 0 rgba(255,255,255,1)',
                ],
				 [
                    'type'  => 'contener_border',
                    'label' => $this->la('Border du tag phenyxIndex'),
                    'name'  => 'phenyxIndex_border',
                ],
				[
                    'type'  => 'larger',
                    'label' => $this->la('Largeur du tag phenyxIndex'),
                    'name'  => 'phenyxIndex_width',
                ],
				[
                    'type'        => 'padding',
                    'label'       => $this->la('Espacement intérieur du tag phenyxIndex- padding (px)'),
                    'name'        => 'phenyxIndex_padding',
                ...
                [
                    'type'        => 'select',
                    'label'       => $this->la('Utiliser une image pour le Background Papier'),
                    'name'        => 'enable_papier_bg',
                    'default_val' => '0',
                    'options'     => [
                        'id'    => 'id',
                ...
                [
                    ...
                    'label'            => $this->la('Select Papier Class Image'),
		...
		$fields_forms['familyType'] = [
            ...
            'input'   => [
				 ...
				 [
                    'type'       => 'infoheading',
                    'label'      => $this->la('Réglage FX '),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
                [
                    'type'  => 'element_before',
                    'label' => $this->la('Lien Image Education Before'),
                    'name'  => 'education_image_before',
                ],
		...
		$fields_forms['footerseetings'] = [
            'legend'  => [
                'title' => $this->la('Le Footer'),
            ],
            'id_form' => 'footer_theme_seetings',
            'input'   => [
                [
                    'type'       => 'infoheading',
                    'label'      => $this->la('Réglage généraux :'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
                [
                    'type'        => 'select',
                    'label'       => $this->la('Footer style'),
                    'name'        => 'footer_style',

                    'default_val' => 'footer_style_full_boxed',
                    'desc'        => $this->la('Choose different footer style'),
                    'options'     => [
                        'id'    => 'id',
                        'name'  => 'name',
                        'query' => [
                ...
                [
                    'type'        => 'select',
                    'label'       => $this->la('Footer width'),
                    'name'        => 'footer_width',
                    'default_val' => '1170',
                    'desc'        => $this->la('Select Footer width. (Works with Footer Largeur Fixe)'),
                    'options'     => [
                        'id'    => 'id',
                        'name'  => 'name',
                        'query' => [
                ...
                [
                    'type'        => 'padding',
                    'label'       => $this->la('Espacement intérieur du Footer- padding (px)'),
                    'name'        => 'footer_padding',
                    'default_val' => '0 0 0 0',
                ],
                [
                    'type'        => 'margin',
                    'label'       => $this->la('Espacement extérieur du Footer - margin (px)'),
                    'name'        => 'footer_margin',
                    'default_val' => '0 0 0 0',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur du Background du Footer'),
                    'name'        => 'bck_footer_color',
                    'default_val' => '#fff',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur du Footer'),
                    'name'        => 'footer_color',
                    'default_val' => '#fff',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur des Liens du Footer'),
                    'name'        => 'footer_link_color',
                    'default_val' => '#fff',
                ],
                [
                ...
                [
                    'type'       => 'infoheading',
                    'label'      => $this->la('Réglage de la Police'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
                [
                    'type'       => 'googlefont',
                    'label'      => $this->la('Police du Footer'),
                    'name'       => 'footerfont',
                    'sublabel'   => 'Select additional google font',
                    'colorclass' => 'success',
                ],
                [
                    'type'        => 'select_font_size',
                    'label'       => $this->la('Taille de la Police du Footer'),
                    'name'        => 'footer_f_size',
                    'default_val' => '13',
                    'size'        => 10,
                    'required'    => true,
                ...
                [
                    'type'       => 'infoheading',
                    'label'      => $this->la('Réglage #footer .like_h4'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
                [
                    'type'        => 'height',
                    'label'       => $this->la('Hauteur du like_h4'),
                    'name'        => 'like_h4_height',
                    'default_val' => '60',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur de la Police du like_h4'),
                    'name'        => 'like_h4_f_color',
                ...
                [
                    'type'        => 'select_font_size',
                    'label'       => $this->la('Taille de la Police like_h4'),
                    'name'        => 'like_h4_f_size',
                    'default_val' => '13',
                    'size'        => 10,
                    'required'    => true,
                ...
                [
                    'type'        => 'select_line_height',
                    'label'       => $this->la('Hauteur de Ligne like_h4'),
                    'name'        => 'like_h4_f_line_height',
                    'default_val' => '13',
                    'size'        => 10,
                    'required'    => true,
                ...
                [
                    'type'    => 'select',
                    'label'   => $this->la('Transformation du texte like_h4'),
                    'name'    => 'like_h4_font_transform',
                    'options' => [
                        'id'    => 'id',
                        'name'  => 'name',
                ...
                [
                    'type'        => 'padding',
                    'label'       => $this->la('Espacement intérieur dulike_h4- padding (px)'),
                    'name'        => 'like_h4_padding',
                    'default_val' => '0 0 0 0',
                ],
                [
                    'type'        => 'margin',
                    'label'       => $this->la('Espacement extérieur du like_h4 - margin (px)'),
                    'name'        => 'like_h4_margin',
                    'default_val' => '0 0 0 0',
                ],
                [
                ...
                [
                    'type'  => 'element_before',
                    'label' => $this->la('Footer Before'),
                    'name'  => 'footer_before',
                ],
                [
                    'type'  => 'element_after',
                    'label' => $this->la('Footer After'),
                    'name'  => 'footer_after',
                ],
        ...
        $fields_forms['Bouton'] = [
            ...
            'input'   => [
                ...
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur du Background'),
                    'name'        => 'button_bg_color',
                    'default_val' => 'transparent',
                    'predefine'   => [
                    ],
                ...
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur du Texte Hover'),
                    'name'        => 'button_hvr_txt_color',
                    'default_val' => '#FFF',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur du Background Hover'),
                    'name'        => 'button_hvr_bg_color',
                    'default_val' => '#000000',
                    'predefine'   => [
                    ],
        ...
        $fields_forms['signIn'] = [
            ...
            'input'   => [
                ...
                [
                    'type'        => 'contener_position',
                    'label'       => $this->la('Position du Conteneur'),
                ...
                [
                    'type'  => 'text',
                    'label' => $this->la('Z index du Conteneur'),
                    'name'  => 'hookDisplayNav_zindex',
                ],
                [
                    'type'        => 'larger',
                    'label'       => $this->la('Largeur du Conteneur'),
                    'name'        => 'hookDisplayNav_width',
                    'default_val' => '150',
                ],
                [
                    'type'        => 'img_upload',
                    'label'       => $this->la('Pictogramme mon Espace'),
                    'name'        => 'EPH_PICTO_MYSPACE',
                    'default_val' => '',
                ],
                ...
                [
                    'type'        => 'switch',
                    'label'       => $this->la('Pictogramme Dynamique'),
                    'name'        => 'dynamic_picto_space',
				...
				[
                    'type'        => 'background_position',
                    'label'       => $this->la('BackGround Position du Cadenas'),
                    'name'        => 'cadenas_bck_position',
                ],
				[
					'type'        => 'background_size',
					'label'       => $this->la('BackGround Size du Cadenas'),
                    'name'        => 'cadenas_bck_size',
				],
                [
                    'type'        => 'margin',
                    'label'       => $this->la('Espacement extérieur du cadenas - margin (px)'),
                    'name'        => 'cadenas_margin',
                    'default_val' => '0 0 0 0',
                ],
                [
                    'type'        => 'larger',
                    'label'       => $this->la('Largeur du Cadenas'),
                    'name'        => 'cadenas_width',
                    'default_val' => '50',
                ],
                [
                    'type'        => 'height',
                    'label'       => $this->la('Hauteur du Cadenas'),
                    'name'        => 'cadenas_height',
                    'default_val' => '100',
                ],
				...
				[
                    'type'        => 'img_upload',
                    'label'       => $this->la('Pictogramme Popup Ouverte'),
                    'name'        => 'EPH_FIXED_PICTO_MYSPACE',
                    'default_val' => '',
                ],
				[
                    'type'        => 'color',
                    'label'       => $this->la('BackGround du Cadenas'),
                    'name'        => 'cadenas_bck_color',
                    'default_val' => 'transparent',
                ],
				[
        ...
        $fields_forms['sliderHome'] = [
            ...
            'input'   => [
				 ...
				 [
                    'type'       => 'infoheading',
                    'label'      => $this->la('Revslider Home'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Appliquer un BackGround au Slider'),
                    'name'        => 'slider_bck_color',
                    'default_val' => 'transparent',
                    'predefine'   => [
                ...
                [
                    'type'        => 'margin',
                    'label'       => $this->la('Espacement extérieur du conteneur - margin (%)'),
                    'name'        => 'slider_row_margin',
                    'default_val' => '0 0 0 0',
                ],
                [
                    'type'        => 'margin',
                    'label'       => $this->la('Espacement du Slider - margin (%)'),
                    'name'        => 'slider_margin',
                    'default_val' => '0 0 0 0',
                ],
                [
                    'type'        => 'bootstrap_offset',
                    'label'       => $this->la('Larger Bootsrap du conteneur'),
                    'name'        => 'slider_bootsrap_width',
                    'default_val' => '12',
                ],
                [
                    'type'        => 'bootstrap_offset',
                    'label'       => $this->la('Espacement extérieur Bootsrap Offset'),
                    'name'        => 'slider_offset',
                    'default_val' => '0',
				...
				[
                    'type'       => 'infoheading',
                    'label'      => $this->la('Revslider Index Bottom'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
				[
    ...
    public function renderPolygon() {
        ...
        $fields_forms['polygon_param'] = [
            ...
            'legend'  => [
                'title' => $this->la('Champs d‘application'),
            ],
            'id_form' => 'theme_polygon_param',
            'input'   => [
				[
                    'type'       => 'infoheading',
                    'label'      => $this->la('Front Office Public'),
                    'name'       => 'infoheading',
                    'colorclass' => 'info_custom success',
                ],
                [
                    'type'        => 'switch',
                    'label'       => $this->la('Appliquer la classe Polygone au Menu'),
                    'name'        => 'polygon_menu',
                    'class'       => 't',
                    'is_bool'     => true,
                    'default_val' => '1',
                ...
                [
                    'type'        => 'switch',
                    'label'       => $this->la('Appliquer la classe Polygone au Corps'),
                    'name'        => 'polygon_core',
                    'class'       => 't',
                    'is_bool'     => true,
                    'default_val' => '1',
                ...
                [
                    'type'        => 'switch',
                    'label'       => $this->la('Appliquer la classe Polygone sur Parallax'),
                    'name'        => 'polygon_parallax',
                    'class'       => 't',
                    'is_bool'     => true,
                    'default_val' => '1',
                ...
                [
                    'type'        => 'switch',
                    'label'       => $this->la('Appliquer la classe Polygone au Footer'),
                    'name'        => 'polygon_footer',
                    'class'       => 't',
                    'is_bool'     => true,
                    'default_val' => '1',
        ...
        $fields_forms['polygon_color'] = [
            'legend'  => [
                'title' => $this->la('Appliquer un effet Polygone dans le menu'),
            ],
            'id_form' => 'theme_polygon_colors',
            'input'   => [
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur Polygone 1'),
                    'name'        => 'polygon_menu_color_1',
                    'default_val' => '#56589a',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur Polygone 2'),
                    'name'        => 'polygon_menu_color_2',
                    'default_val' => '#9ea3cf',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur Polygone 3'),
                    'name'        => 'polygon_menu_color_3',
                    'default_val' => '#838bc3',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur Polygone 4'),
                    'name'        => 'polygon_menu_color_4',
                    'default_val' => '#6c75b1',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur Polygone 5'),
                    'name'        => 'polygon_menu_color_5',
                    'default_val' => '#4f589b',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur Polygone 6'),
                    'name'        => 'polygon_menu_color_6',
                    'default_val' => '#3b4489',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur Polygone 7'),
                    'name'        => 'polygon_menu_color_7',
                    'default_val' => '#282f6c',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur Polygone 8'),
                    'name'        => 'polygon_menu_color_8',
                    'default_val' => '#0f1039',
                ],
                [
                    'type'        => 'color',
                    'label'       => $this->la('Couleur Polygone 9'),
                    'name'        => 'polygon_menu_color_9',
                    'default_val' => '#ff7e00',
                ],
    ...
    public function renderGeneralSeetingsForm() {
		...
		$fields_forms['logos'] = [
            ...
            'legend'  => [
                'title' => $this->la('Mes logos et Images'),
            ],
            'id_form' => 'theme_images',
            'input'   => [
                [
                    'type'        => 'img_upload',
                    'label'       => $this->la('Le logo du site'),
                    'name'        => 'EPH_LOGO',
                    'default_val' => '',
                ],
                [
                    'type'        => 'img_upload',
                    'label'       => $this->la('Logo mobile du site'),
                ...
                [
                    'type'     => 'radio',
                    'label'    => $this->la('Position Du Logo'),
                    'name'     => 'logo_position',
                    'required' => true,
                    'values'   => [
                        [
                            'id'    => 'left',
                            'value' => 'left',
                            'label' => $this->la('A Gauche'),
                        ],
                        [
                            'id'    => 'middle',
                            'value' => 'middle',
                            'label' => $this->la('Au centre'),
                        ],
                    ],
                ],
                ...
                [
                    'type'        => 'margin',
                    'label'       => $this->la('Espacement extérieur du Logo - margin (px)'),
                    'name'        => 'logo_margin',
                    'default_val' => '0 0 0 0',
                ],
                [
                    'type'  => 'height',
                    'label' => $this->la('Hauteur du Logo'),
                    'desc'  => $this->la('Laisser vide pour auto'),
                    'name'  => 'logo_height',
                ],
                [
                    'type'  => 'larger',
                    'label' => $this->la('Largeur du Logo'),
                    'desc'  => $this->la('Laisser vide pour auto'),
                    'name'  => 'logo_width',
                ],
                [
                    'type'        => 'background_position',
                    'label'       => $this->la('Position du BackGround du Logo'),
                    'name'        => 'logo_bg_position',
                    
                ],
                [
                    'type'  => 'background_size',
                    'label' => $this->la('Taille du Background du Logo'),
                    'name'  => 'logo_bck_size',
                ],
                [
                    'type'        => 'img_upload',
                    'label'       => $this->la('Le logo des Factures'),
                    'name'        => 'EPH_LOGO_INVOICE',
                    'default_val' => '',
                ],
                [
                    'type'        => 'img_upload',
                    'label'       => $this->la('Le Tampon de la société'),
                    'name'        => 'EPH_SOURCE_STAMP',
                    'default_val' => '',
                ],
                [
                    'type'        => 'img_upload',
                    'label'       => $this->la('Le logo des réseaux sociaux'),
                    'name'        => 'EPH_OGGPIC',
                    'default_val' => '',
                ],
                [
                    'type'        => 'favicon',
                    'label'       => $this->la('Le Favicon'),
                    'name'        => 'EPH_FAVICON',
                    'default_val' => '',
                ],
        ...
        $fields_forms['mailseetings'] = [
            'tinymce' => true,
            'legend'  => [
                'title' => $this->la('Réglage des Emails'),
            ],
            'id_form' => 'email_seetings',
            'input'   => [
                [
                    'type'        => 'img_upload',
                    'label'       => $this->la('Le logo des emails'),
                    'name'        => 'EPH_LOGO_MAIL',
                    'default_val' => '',
                ],
                [
                    'type'         => 'textarea',
                    'label'        => $this->la('Tags Footer Pour les Emails'),
    ...
    public function generateTabDocuments() {
        ...
        $catalogue = file_exists(_EPH_CATALOGUE_DIR_ . 'catalogue.pdf');
        $reglement = file_exists(_EPH_IMG_DIR_ . 'reglement.pdf');
        $deontologie = file_exists(_EPH_IMG_DIR_ . 'deontologie.pdf');
    ...
    public function renderCustomCssForm() {
        ...
        $fields_forms['cssCorp'] = [
            ...
            'input'   => [
                ...
                [
                    'type'        => 'customtextarea',
                    'label'       => $this->la('Custom JS'),
                    'name'        => 'custom_js',
                    'class'       => "custom_js_class",
                    'mode'        => 'javascript',
                    'desc'        => $this->la('Please Enter Your Custom JS'),
                    'rows'        => 30,
                    'cols'        => 25,
                    'default_val' => '',
                ],
        ...
        $fields_forms['cssMenu'] = [
            'tinymce' => true,
            'legend'  => [
                'title' => $this->la('JS/CSS menu Front Office'),
            ],
            ...
            'input'   => [
                ...
                [
                    'type'        => 'customtextarea',
                    'label'       => $this->la('CSS personnalisé du menu Front Office'),
                ...
                [
                    'type'        => 'customtextarea',
                    'label'       => $this->la('JS personnalisé du menu Front Office'),
                    'name'        => 'custom_menu_js',
                    'class'       => "custom_js_class",
                    'mode'        => 'javascript',
                    'desc'        => $this->la('Please Enter Your Custom JS'),
    ...
    public function assignFormValue($fields_form) {
        ...
        $this->tpl_form_vars['EPH_HOME_QUALIOPI_ACTIVE'] = Configuration::get('EPH_HOME_QUALIOPI_ACTIVE');
    ...
    public function GetAllBGImage() {
        ...
        $pattern_images_url = Context::getContext()->company->getBaseURL() . 'img/theme/';
        $pattern_images = [];
    ...
    public function GetAllPattern() {
        ...
        $pattern_images_url = Context::getContext()->company->getBaseURL() . 'themes/' . $theme_dir . '/img/patterns/';
        $pattern_images = [];
            ...
            if (isset($mvalue['lang']) && $mvalue['lang'] == true && isset($mvalue['name'])) {
                ...
                if (isset($mvalue['name'])) {
                    ...
                    if (isset($mvalue['type']) && ($mvalue['type'] == "element_before") || ($mvalue['type'] == "element_after")) {
                        ...
                        } else if ($fields_value->bck_type == 'gradient') {
            ...
            if (is_array($files) && count($files)) {
                ...
                foreach ($files as $image) {
                    ...
                    case 'EPH_SOURCE_STAMP':
                        $destinationFile = _SHOP_ROOT_DIR_ . '/img/companyStamp.' . $ext;
    ...
    public function ajaxProcessUpdateTheme() {
		...
		if($bootsrap_index != $this->bootsrap_index) {
			...
			if(file_exists(_EPH_ROOT_DIR_ . '/template/front/index_'.$bootsrap_index.'.tpl')) {
				copy(_EPH_ROOT_DIR_ . '/template/front/index_'.$bootsrap_index.'.tpl', _EPH_THEME_DIR_.'index.tpl');
			}
		}
		...
		if($bootsrap_education != $this->bootsrap_education) {
			...
			if(file_exists(_EPH_ROOT_DIR_ . '/template/front/education_'.$bootsrap_education.'.tpl')) {
				copy(_EPH_ROOT_DIR_ . '/template/front/education_'.$bootsrap_education.'.tpl', _EPH_THEME_DIR_.'education.tpl');
			}
		}
    ...
    protected function checkPostedDatas() {
        ...
        if ($mail && !preg_match('#^[\w.-]+@[\w.-]+\.[a-zA-Z]{2,6}$#', $mail)) {
            $this->errors[] = $this->la('There is an error in your email syntax!');
        } else

        if ($website && (!Validate::isURL($website) || !Validate::isAbsoluteUrl($website))) {
            $this->errors[] = $this->la('There is an error in your URL syntax!');
        } else
    ...
    protected function checkVersionsAndCompatibility() {
        ...
        if (!preg_match('#^[0-9][.][0-9]$#', Tools::getValue('theme_version')) ||
            ...
            $this->errors[] = $this->la('Syntax error on version field. Only digits and periods (.) are allowed, and the compatibility version should be increasing or at least be equal to the previous version.');
        }
    ...
    protected function checkNames() {
        ...
        if (!$author || !Validate::isGenericName($author) || strlen($author) > static::MAX_NAME_LENGTH) {
            $this->errors[] = $this->la('Please enter a valid author name');
        } else

        if (!$themeName || !Validate::isGenericName($themeName) || strlen($themeName) > static::MAX_NAME_LENGTH) {
            $this->errors[] = $this->la('Please enter a valid theme name');
        }
    ...
    protected function checkDocumentation() {
        ...
        if (isset($_FILES['documentation']) && $_FILES['documentation']['name'] != '') {
            ...
            if (!in_array($extension, $extensions)) {
                $this->errors[] = $this->la('File extension must be .txt or .pdf');
            } else

            if ($_FILES['documentation']['error'] > 0) {
                $this->errors[] = $this->la('An error occurred during documentation upload');
            } else

            if ($_FILES['documentation']['size'] > 1048576) {
                $this->errors[] = $this->la('An error occurred while uploading the documentation. Maximum size allowed is 1MB.');
            } else

            if (!$name || !Validate::isGenericName($name) || strlen($name) > static::MAX_NAME_LENGTH) {
                $this->errors[] = $this->la('Please enter a valid documentation name');
            }
    ...
    protected function generateArchive() {
        ...
        if ($zip->open(_EPH_CACHE_DIR_ . $zipFileName, ZipArchive::OVERWRITE | ZipArchive::CREATE) === true) {
            ...
            if (!$zip->addFromString('Config.xml', $this->xml_file)) {
                $this->errors[] = $this->la('Cannot create config file.');
            }
            ...
            if (isset($_FILES['documentation'])) {
                ...
                if (!empty($_FILES['documentation']['tmp_name']) &&
                    ...
                    $this->errors[] = $this->la('Cannot copy documentation.');
                }
            ...
            if ($givenPath !== false) {
                ...
                if ($toComparePath != realpath(_EPH_ALL_THEMES_DIR_)) {
                    $this->errors[] = $this->la('Wrong theme directory path');
                } else {
            ...
            if (!is_file(_EPH_CACHE_DIR_ . $zipFileName)) {
                $this->errors[] = $this->la(sprintf('Could not create %1s', _EPH_CACHE_DIR_ . $zipFileName));
            }
        ...
        $this->errors[] = $this->la('An error occurred during the archive generation');
    }
            ...
            'form' => [
                ...
                'input'   => [
                    [
                        ...
                        'label'   => $this->la('Choose the theme that you want to export'),
                        'options' => [
                            'id'    => 'id',
                            'name'  => 'name',
                            'query' => $themeList,
    ...
    protected function renderExportTheme1() {
        ...
        $fieldsForm = [
            'form' => [
                'tinymce' => false,
                'legend'  => [
                    'title' => $this->la('Theme configuration'),
                    'icon'  => 'icon-picture',
                ],
                'input'   => [
                    [
                    ...
                    [
                        'type'  => 'text',
                        'name'  => 'website',
                        'label' => $this->la('Website'),
                    ],
                    [
                        'type'  => 'text',
                        'name'  => 'theme_name',
                        'label' => $this->la('Theme name'),
                    ],
                    [
                        'type'  => 'text',
                        'name'  => 'theme_directory',
                        'label' => $this->la('Theme directory'),
                    ],
                    [
                        'type'  => 'text',
                        'name'  => 'body_title',
                    ...
                    [
                        'type'  => 'text',
                        'name'  => 'theme_version',
                        'label' => $this->la('Theme version'),
                    ],
                    [
                        'type'  => 'text',
                        'name'  => 'compa_from',
                        'label' => $this->la('Compatible from'),
                    ],
                    [
                        'type'  => 'text',
                        'name'  => 'compa_to',
                        'label' => $this->la('Compatible to'),
                    ],
                    [
                        'type'  => 'file',
                        'name'  => 'documentation',
                        'label' => $this->la('Documentation'),
                    ],
                    [
                        'type'  => 'text',
                        'name'  => 'documentationName',
                        'label' => $this->la('Documentation name'),
                    ],
                ],
                'submit'  => [
                    'title' => $this->la('Save'),
        ...
        if (count($toInstall) > 0) {
            ...
            $fieldsForm['form']['input'][] = [
                'type'   => 'checkbox',
                'label'  => $this->la('Select the theme\'s modules that you wish to export'),
                'values' => [
        ...
        $fieldsValue['documentationName'] = $this->la('documentation');
    ...
    public function processImportTheme() {
        ...
        if (!($this->tabAccess['add'] && $this->tabAccess['delete']) || _EPH_MODE_DEMO_) {
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['themearchive']) && isset($_POST['filename']) && Tools::isSubmit('theme_archive_server')) {
                ...
                if (Tools::getValue('filename') != '') {
                    ...
                    if ($file[0]['error'] === 0) {
                        ...
                        if (Tools::ZipTest($sandbox . Theme::UPLOADED_THEME_DIR_NAME . '.zip')) {
                            ...
                            $this->errors[] = $this->la('Zip file seems to be broken');
                        }
                ...
                if (Tools::getValue('themearchiveUrl') != '') {
                    ...
                    if (!Validate::isModuleUrl($url = Tools::getValue('themearchiveUrl'), $this->errors)) {
                        $this->errors[] = $this->la('Only zip files are allowed');
                    } else

                    if (!Tools::copy($url, $sandbox . Theme::UPLOADED_THEME_DIR_NAME . '.zip')) {
                        $this->errors[] = $this->la('Error during the file download');
                    } else
                ...
                if (Tools::getValue('theme_archive_server') != '') {
                    ...
                    if (!copy($filename, $sandbox . Theme::UPLOADED_THEME_DIR_NAME . '.zip')) {
                        $this->errors[] = $this->la('An error has occurred during the file copy.');
                    } else
                    ...
                    $this->errors[] = $this->la('You must upload or enter a location of your zip');
                }
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $this->errors[] = sprintf($this->la('The file size exceeds the size allowed by the server. The limit is set to %s MB.'), '<b>' . $maxPost . '</b>');
            }
    ...
    protected function extractTheme($themeZipFile, $sandbox) {
        ...
        if (!($this->tabAccess['add'] && $this->tabAccess['edit'] && $this->tabAccess['delete']) || _EPH_MODE_DEMO_) {
            $this->errors[] = $this->la('You do not have permission to extract here.');
        ...
        $this->errors[] = $this->la('Error during zip extraction');
    ...
    protected function installTheme($themeDir, $sandbox = false, $redirect = true) {
        ...
        if ($this->tabAccess['add'] && $this->tabAccess['delete'] && !_EPH_MODE_DEMO_) {
            ...
            if (!$xml) {
                ...
                if (!$xml) {
                    $this->errors[] = $this->la('Bad or missing configuration file.');
                }
                ...
                foreach ($importedTheme as $theme) {
                    ...
                    if (Validate::isLoadedObject($theme)) {
                        ...
                        if (!copy($sandbox . $themeDir . $configFile, _SHOP_ROOT_DIR_ . '/app/xml/themes/' . $theme->directory . '.xml')) {
                            $this->errors[] = $this->la('Can\'t copy configuration file');
                        }
    ...
    protected function importThemeXmlConfig(SimpleXMLElement $xml, $themeDir = false) {
        ...
        if ($this->isThemeInstalled($thName)) {
            return [sprintf($this->la('Theme %s already installed.'), $thName)];
        }
        ...
        foreach ($xml->variations->variation as $variation) {
            ...
            if (!is_dir(_EPH_ALL_THEMES_DIR_ . $newTheme->directory)) {
                ...
                if (!mkdir(_EPH_ALL_THEMES_DIR_ . $newTheme->directory)) {
                    return sprintf($this->la('Error while creating %s directory'), _EPH_ALL_THEMES_DIR_ . $newTheme->directory);
                }
            ...
            if ($newTheme->id > 0) {
                ...
                $newThemeArray[] = sprintf($this->la('Error while installing theme %s'), $newTheme->name);
            }
    ...
    public function renderImportTheme() {
        ...
        if ($this->context->mode != Context::MODE_HOST) {
            $fieldsForm[0] = [
                'form' => [
                    'tinymce' => false,
                    'legend'  => [
                        'title' => $this->la('Import from your computer'),
                        'icon'  => 'icon-picture',
                    ],
                    'input'   => [
                        [
                            'type'  => 'file',
                            'label' => $this->la('Zip file'),
                            'desc'  => $this->la('Browse your computer files and select the Zip file for your new theme.'),
                            'name'  => 'themearchive',
                        ],
                    ],
                    'submit'  => [
            ...
            $fieldsForm[1] = [
                'form' => [
                    'tinymce' => false,
                    'legend'  => [
                        'title' => $this->la('Import from the web'),
                        'icon'  => 'icon-picture',
                    ],
                    'input'   => [
                        [
                            'type'  => 'text',
                            'label' => $this->la('Archive URL'),
                            'desc'  => $this->la('Indicate the complete URL to an online Zip file that contains your new theme. For instance, "http://example.com/files/theme.zip".'),
            ...
            $fieldsForm[2] = [
                'form' => [
                    'tinymce' => false,
                    'legend'  => [
                        'title' => $this->la('Import from FTP'),
                        'icon'  => 'icon-picture',
                    ],
                    'input'   => [
                        [
                            'type'    => 'select',
                            'label'   => $this->la('Select the archive'),
                            'name'    => 'theme_archive_server',
                            'desc'    => $this->la('This selector lists the Zip files that you uploaded in the \'/themes\' folder.'),
                            'options' => [
                                'id'    => 'id',
                                'name'  => 'name',
        ...
        $this->context->smarty->assign(
            [
                ...
                'add_new_theme_label' => $this->la('Create a new theme'),
            ]
        );
        ...
        if ($xml) {
            ...
            $fieldsForm = [
                'form' => [
                    'tinymce'     => false,
                    'legend'      => [
                        'title' => $this->la('Modules to install'),
                        'icon'  => 'icon-picture',
                    ],
                    'description' => $this->la('Themes often include their own modules in order to work properly. This option enables you to choose which modules should be enabled and which should be disabled. If you are unsure of what to do next, just press the "Save" button and proceed to the next step.'),
                    'input'       => [
                        [
                            'type'  => 'shop',
                            'label' => $this->la('Shop association'),
            ...
            if (count($toInstall) > 0) {
                $fieldsForm['form']['input'][] = [
                    'type'   => 'checkbox',
                    'label'  => $this->la('Select the theme\'s modules you wish to install'),
                    'values' => [
                        'query' => $toInstall,
                        'id'    => 'id',
                        'name'  => 'name',
                    ...
                    'expand' => [
                        ...
                        'default'     => 'show',
                        'show'        => ['text' => $this->la('Show'), 'icon' => 'plus-sign-alt'],
                        'hide'        => ['text' => $this->la('Hide'), 'icon' => 'minus-sign-alt'],
                    ],
                ];
            }
            ...
            if (count($toEnable) > 0) {
                $fieldsForm['form']['input'][] = [
                    'type'   => 'checkbox',
                    'label'  => $this->la('Select the theme\'s modules you wish to enable'),
                    'values' => [
                        'query' => $toEnable,
                        'id'    => 'id',
                        'name'  => 'name',
            ...
            if (count($toDisable) > 0) {
                $fieldsForm['form']['input'][] = [
                    'type'   => 'checkbox',
                    'label'  => $this->la('Select the theme\'s modules you wish to disable'),
                    'values' => [
                        'query' => $toDisable,
                        'id'    => 'id',
                        'name'  => 'name',
            ...
            foreach ($shops as $shop) {
                ...
                $fieldsForm['form']['input'][] = [
                    'type'             => 'checkbox',
                    'label'            => sprintf($this->la('Select the modules from the old %1s theme that you wish to disable'), $shopTheme->directory),
    ...
    public function updateOptionTbSourceFaviconCode() {
        ...
        $idShop = (int) $this->context->company->id;
    ...
    public function ajaxProcessLeftMeta() {
        ...
        if ($result) {
            $this->ajaxDie(json_encode(['success' => 1, 'text' => $this->la('The status has been updated successfully.')]));
        } else {
            $this->ajaxDie(json_encode(['success' => 0, 'text' => $this->la('An error occurred while updating this meta.')]));
        }
    ...
    public function renderOptions() {
        ...
        if ($this->fields_options && is_array($this->fields_options)) {
            ...
            $helper->title = $this->la('Theme appearance');
            $helper->toolbar_btn = [
                'save' => [
                    'href' => '#',
                    'desc' => $this->la('Save'),
