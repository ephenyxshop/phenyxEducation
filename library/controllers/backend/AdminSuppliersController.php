...
class AdminSuppliersControllerCore extends AdminController {
    ...
    public function __construct() {
        ...
        $this->publicName = $this->la('Suppliers');
	...
	public function generateParaGridScript() {
		...
		$this->paramToolbar = [
            'items' => [
                ...
                [
                    'type'     => '\'button\'',
                    'icon'     => '\'ui-icon-disk\'',
                    'label'    => '\'' . $this->la('Ajouter un Fournisseur') . '\'',
		...
		$this->paramTitle = '\'' .$this->la('Liste des fournisseurs'). '\'';
            ...
            '#grid_' . $this->controller_name => [
                ...
                return {
                    ...
                    items: {
                        ...
                        "edit": {
                            name: \'' . $this->la('Editer ou modifier le fournisseur  ') . '\'+rowData.name,
                            icon: "edit",
                        ...
                        "delete": {
                            name: \'' . $this->la('Supprimer le fournisseur ') . '\'+rowData.name,
                            icon: "delete",
    ...
    public function getSupplierRequest() {
        ...
        foreach ($suppliers as &$supplier) {
            ...
            if ($supplier['active'] == 1) {
                $supplier['active'] = '<div class="toggle-active"></div>';
            } else {
                $supplier['active'] = '<div class="toggle-inactive"></div>';
            }
    ...
    public function ajaxProcessgetSupplierFields() {
        ...
        die(Tools::jsonEncode($this->getSupplierFields()));
    }
	...
	public function renderForm() {
        ...
        $this->fields_form = [
            ...
            'input'  => [
				...
				[
                    'type'     => 'text',
                    'label'    => $this->la('Code Fournisseur'),
                    'name'     => 'supplier_code',
                    'required' => true,
                    'col'      => 4,
                ],
				...
				[
                	'type'  => 'text',
                	'label' => $this->la('N° TVA Intracommunautaire'),
                	'name'  => 'vat_number',
            	],
				[
                    'type'     => 'text',
                    'label'    => $this->la('Compte Comptable'),
                    'name'     => 'stdAccount',
                    'required' => true,
                    'col'      => 4,
                ],
                [
                    ...
                    'maxlength' => 16,
                    'col'       => 4,
                    'hint'      => $this->la('Company name for this supplier'),
                ],
                [
                    'type'         => 'textarea',
                    ...
                    'hint'         => [
                        ...
                        $this->la('Will appear in the list of suppliers.'),
                    ],
                ...
                [
                    ...
                    'maxlength' => 16,
                    'col'       => 4,
                    'hint'      => $this->la('Phone number for this supplier'),
                ],
                [
                    'type'      => 'text',
                    ...
                    'maxlength' => 16,
                    'col'       => 4,
                    'hint'      => $this->la('Mobile phone number for this supplier.'),
                ],
                [
                    'type'      => 'text',
                ...
                [
                    ...
                    'size'          => $imageSize,
                    'hint'          => $this->la('Upload a supplier logo from your computer.'),
                ],
                [
                    'type'  => 'text',
