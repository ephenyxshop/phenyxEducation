...
class AdminAttributesControllerCore extends AdminController {
    ...
    public function renderForm() {
        ...
        $this->fields_form = [
            ...
            'input'  => [
                ...
                [
                    ...
                    'hint'     => $this->la('Choose the attribute group for this value.'),
                ],
                [
                    'type'     => 'text',
                    'label'    => $this->la('Value'),
        ...
        $this->fields_form['input'][] = [
            ...
            'label' => $this->la('Color'),
            'name'  => 'color',
            'hint'  => $this->la('Choose a color with the color picker, or enter an HTML color (e.g. "lightblue", "#CC6600").'),
        ];

        $this->fields_form['input'][] = [
            'type'  => 'file',
            'label' => $this->la('Texture'),
            'name'  => 'texture',
            'hint'  => [
                $this->la('Upload an image file containing the color texture from your computer.'),
                $this->la('This will override the HTML color!'),
            ],
        ];

        $this->fields_form['input'][] = [
            'type'  => 'current_texture',
            'label' => $this->la('Current texture'),
        ...
        $this->fields_form['buttons'] = [
            'save-and-stay' => [
                'title' => $this->la('Save then add another value'),
