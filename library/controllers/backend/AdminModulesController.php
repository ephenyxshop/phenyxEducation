...
class AdminModulesControllerCore extends AdminController {
    ...
    public function __construct() {
        ...
        $this->bootstrap = true;
        $this->publicName = $this->la('Modules');
        $this->table = 'module';
        $this->className = 'Module';
        $this->publicName = $this->la('Gestion des Modules');
        parent::__construct();

        register_shutdown_function('displayFatalError');

        // Set the modules categories
        $this->list_modules_categories['administration']['name'] = $this->la('Administration');
        $this->list_modules_categories['advertising_marketing']['name'] = $this->la('Advertising and Marketing');
        $this->list_modules_categories['analytics_stats']['name'] = $this->la('Analytics and Stats');
        $this->list_modules_categories['billing_invoicing']['name'] = $this->la('Taxes & Invoicing');
        $this->list_modules_categories['checkout']['name'] = $this->la('Checkout');
        $this->list_modules_categories['content_management']['name'] = $this->la('Content Management');
        $this->list_modules_categories['customer_reviews']['name'] = $this->la('Customer Reviews');
        $this->list_modules_categories['export']['name'] = $this->la('Export');
        $this->list_modules_categories['emailing']['name'] = $this->la('Emailing');
        $this->list_modules_categories['front_office_features']['name'] = $this->la('Front office Features');
        $this->list_modules_categories['i18n_localization']['name'] = $this->la('Internationalization and Localization');
        $this->list_modules_categories['merchandizing']['name'] = $this->la('Merchandising');
        $this->list_modules_categories['migration_tools']['name'] = $this->la('Migration Tools');
        $this->list_modules_categories['payments_gateways']['name'] = $this->la('Payments and Gateways');
        $this->list_modules_categories['payment_security']['name'] = $this->la('Site certification & Fraud prevention');
        $this->list_modules_categories['pricing_promotion']['name'] = $this->la('Pricing and Promotion');
        $this->list_modules_categories['quick_bulk_update']['name'] = $this->la('Quick / Bulk update');
        $this->list_modules_categories['search_filter']['name'] = $this->la('Search and Filter');
        $this->list_modules_categories['seo']['name'] = $this->la('SEO');
        $this->list_modules_categories['shipping_logistics']['name'] = $this->la('Shipping and Logistics');
        $this->list_modules_categories['slideshows']['name'] = $this->la('Slideshows');
        $this->list_modules_categories['smart_shopping']['name'] = $this->la('Comparison site & Feed management');
        $this->list_modules_categories['market_place']['name'] = $this->la('Marketplace');
        $this->list_modules_categories['others']['name'] = $this->la('Other Modules');
        $this->list_modules_categories['mobile']['name'] = $this->la('Mobile');
        $this->list_modules_categories['dashboard']['name'] = $this->la('Dashboard');
        $this->list_modules_categories['i18n_localization']['name'] = $this->la('Internationalization & Localization');
        $this->list_modules_categories['emailing']['name'] = $this->la('Emailing & SMS');
        $this->list_modules_categories['social_networks']['name'] = $this->la('Social Networks');
        $this->list_modules_categories['social_community']['name'] = $this->la('Social & Community');
        ...
        $this->modules_categories['favorite'] = $this->la('Favorite');
        $this->modules_categories['administration'] = $this->la('Administration');
        $this->modules_categories['advertising_marketing'] = $this->la('Advertising and Marketing');
        $this->modules_categories['analytics_stats'] = $this->la('Analytics and Stats');
        $this->modules_categories['billing_invoicing'] = $this->la('Taxes & Invoicing');
        $this->modules_categories['checkout'] = $this->la('Checkout');
        $this->modules_categories['content_management'] = $this->la('Content Management');
        $this->modules_categories['customer_reviews'] = $this->la('Customer Reviews');
        $this->modules_categories['export'] = $this->la('Export');
        $this->modules_categories['emailing'] = $this->la('Emailing');
        $this->modules_categories['front_office_features'] = $this->la('Front office Features');
        $this->modules_categories['i18n_localization'] = $this->la('Internationalization and Localization');
        $this->modules_categories['merchandizing'] = $this->la('Merchandising');
        $this->modules_categories['migration_tools'] = $this->la('Migration Tools');
        $this->modules_categories['payments_gateways'] = $this->la('Payments and Gateways');
        $this->modules_categories['payment_security'] = $this->la('Site certification & Fraud prevention');
        $this->modules_categories['pricing_promotion'] = $this->la('Pricing and Promotion');
        $this->modules_categories['quick_bulk_update'] = $this->la('Quick / Bulk update');
        $this->modules_categories['search_filter'] = $this->la('Search and Filter');
        $this->modules_categories['seo'] = $this->la('SEO');
        $this->modules_categories['shipping_logistics'] = $this->la('Shipping and Logistics');
        $this->modules_categories['slideshows'] = $this->la('Slideshows');
        $this->modules_categories['smart_shopping'] = $this->la('Comparison site & Feed management');
        $this->modules_categories['market_place'] = $this->la('Marketplace');
        $this->modules_categories['others'] = $this->la('Other Modules');
        $this->modules_categories['mobile'] = $this->la('Mobile');
        $this->modules_categories['dashboard'] = $this->la('Dashboard');
        $this->modules_categories['i18n_localization'] = $this->la('Internationalization & Localization');
        $this->modules_categories['emailing'] = $this->la('Emailing & SMS');
        $this->modules_categories['social_networks'] = $this->la('Social Networks');
        $this->modules_categories['social_community'] = $this->la('Social & Community');

        $this->extra_vars = [
            'modules_categories' => $this->modules_categories,
        ];
        
        $this->extracss = $this->pushCSS([_EPH_ADMIN_THEME_DIR_ .   $this->bo_theme . 'css/module.css']);
    ...
    public function generateParaGridScript($regenerate = false) {
        ...
        $this->paramTitle = '\'' . $this->la('Management of Modules') . '\'';
        ...
        $this->paramContextMenu = [
            '#grid_' . $this->controller_name => [
                ...
                return {
                    ...
                    items: {
                        "configure": {
                            name: \'' . $this->la('Configure the Plugins') . ' \',
                            icon: "config",
                        ...
                        "Disable": {
                            name: \'' . $this->la('Désactiver le module') . ' \',
                            icon: "poweroff",
                            visible: function(key, opt){
                                if ( !rowData.installed ) {
                                    return false;
                            ...
                            callback: function(itemKey, opt, e) {
                                disableModule(rowData.name);
                            }
                        },
                        "Enable": {
                            name: \'' . $this->la('Activer le module') . ' \',
                            icon: "toggleon",
                            visible: function(key, opt){
                            if ( !rowData.installed ) {
                                    return false;
                        ...
                        "Reset": {
                            ...
                            visible: function(key, opt){
                               ...
                               if (rowData.has_reset ) {
                                return true;
                               }
                               return false;
                            },
                            callback: function(itemKey, opt, e) {
                                resetModule(rowData.name);
                            }
                        },
                        ...
                        "Install": {
                            ...
                            callback: function(itemKey, opt, e) {
                                installModule(rowData.name)
                            }
                        },
                        "Unistall": {
                            name: \'' . $this->la('Désinstaller') . ' \',
                            icon: "puzzle",
                            visible: function(key, opt){
                            ...
                            callback: function(itemKey, opt, e) {
                                uninstallModule(rowData.name)
                            }
                        },
                        "Delete": {
                            name: \'' . $this->la('Supprimer') . ' \',
                            icon: "delete",
                            visible: function(key, opt){
                       ...
                       "sep2": {
                        ...
                        "DisableOnMobiles": {
                            name: \'' . $this->la('Disable on mobiles') . ' \',
                            icon: "wrench",
                            visible: function(key, opt){
                            if ( !rowData.installed ) {
                                    return false;
                        ...
                        "DisplayOnMobiles": {
                            name: \'' . $this->la('Display on mobiles') . ' \',
                            icon: "wrench",
                            visible: function(key, opt){
                            if ( !rowData.installed ) {
                                    return false;
                        ...
                        "DisableOnTablets": {
                            name: \'' . $this->la('Disable on tablets') . ' \',
                            icon: "wrench",
                            visible: function(key, opt){
                            if ( !rowData.installed ) {
                                    return false;
                        ...
                        "DisplayOnTablets": {
                            name: \'' . $this->la('Display on tablets') . ' \',
                            icon: "wrench",
                            visible: function(key, opt){
                            if ( !rowData.installed ) {
                                    return false;
                        ...
                        "DisableOnComputers": {
                            name: \'' . $this->la('Disable on Computers') . ' \',
                            icon: "wrench",
                            visible: function(key, opt){
                            if ( !rowData.installed ) {
                                    return false;
                        ...
                        "DisplayOnComputers": {
                            name: \'' . $this->la('Display on Computers') . ' \',
                            icon: "wrench",
                            visible: function(key, opt){
                            if ( !rowData.installed ) {
                                    return false;
    ...
    public function checkCategoriesNames($a, $b) {
        ...
        if ($a['name'] === $this->la('Other Modules')) {
            return 1;
        }
    ...
    public function postProcessFilterModules() {
        ...
        $this->setFilterModules(Tools::getValue('module_type'), Tools::getValue('country_module_value'), Tools::getValue('module_install'), Tools::getValue('module_status'));
        Tools::redirectAdmin(static::$currentIndex );
    }
    ...
    public function ajaxProcessUninstallModule() {
            ...
            if (Validate::isLoadedObject($module)) {
                ...
                if (!$module->getPermission('configure')) {
                    ...
                    if (Tools::getValue('keep_data') == '1' && method_exists($module, 'reset')) {
                        ...
                        if ($module->reset()) {
                            Tools::redirectAdmin(static::$currentIndex . '&conf=21&tab_module=' . $module->tab . '&module_name=' . $module->name . '&anchor=' . ucfirst($module->name));
                        } else {
        ...
        if ($this->tabAccess['add'] === '1') {
            ...
            if (isset($_FILES['file']['error']) && $_FILES['file']['error'] != UPLOAD_ERR_OK) {
                ...
                case UPLOAD_ERR_FORM_SIZE:
                    $this->errors[] = sprintf($this->la('File too large (limit of %s bytes).'), Tools::getMaxUploadSize());
                    break;
                case UPLOAD_ERR_PARTIAL:
                    $this->errors[] = $this->la('File upload was not completed.');
                    break;
                case UPLOAD_ERR_NO_FILE:
                    $this->errors[] = $this->la('No file was uploaded.');
                    break;
                default:
                    $this->errors[] = sprintf($this->la('Internal error #%s'), $_FILES['newfile']['error']);
                    break;
                }

            } else
            if (!isset($_FILES['file']['tmp_name']) || empty($_FILES['file']['tmp_name'])) {
                $this->errors[] = $this->la('No file has been selected');
            } else
    ...
    protected function extractArchive($file, $redirect = true) {
            ...
            foreach ($zipFolders as $zipFolder) {
                ...
                if (!in_array($zipFolder, ['.', '..', '.svn', '.git', '__MACOSX'])) {
                    ...
                    if (file_exists(_EPH_MODULE_DIR_ . $zipFolder) && !ConfigurationTest::testDir(_EPH_MODULE_DIR_ . $zipFolder, true, $report, true)) {
                        $this->errors[] = $this->la('There was an error while extracting the module.') . ' ' . $report;
        ...
        if ($success && $redirect && isset($folder)) {
            Tools::redirectAdmin(static::$currentIndex . '&conf=8&anchor=' . ucfirst($folder));
        }
    ...
    public function postProcess() {
        ...
        if ($this->ajax && Validate::isLoadedObject($this->context->employee)) {
                
            $module_name = Tools::getValue('module_name');
            if(!empty($module_name)) {
                $action = Tools::getValue('action');
                require_once _EPH_MODULE_DIR_ . $module_name . '/' . $module_name . '.php';
                $tmpModule = Adapter_ServiceLocator::get($module_name);
            
                if(!empty($action) && method_exists($tmpModule, 'ajaxProcess' . Tools::toCamelCase($action))) {
                    $return = $tmpModule->{'ajaxProcess' . Tools::toCamelCase($action)}();
                }     
            }
    ...
    public function ajaxProcessConfigModule() {
        ...
        $data->assign([
            ...
            '?configure=' . $this->module->name . '&module_name=' . $this->module->name ,
        ]);
    ...
    public function ajaxProcessEnableDevice() {
        ...
        if ($this->tabAccess['edit'] === '1') {
            ...
            if (Validate::isLoadedObject($module)) {
                ...
                if (!$module->getPermission('configure')) {
                    ...
                    $return = [
                        'success' => true,
                        'message' => 'Le module a été activé sur un truc avec succès',
                    ];
     ...
     * @since 1.9.1.0
     */
    public function ajaxProcessDisableDevice() {
        ...
        if ($this->tabAccess['edit'] === '1') {
            ...
            if (Validate::isLoadedObject($module)) {
                ...
                if (!$module->getPermission('configure')) {
                    $return = [
                        'success' => false,
                        'message' => Tools::displayError('You do not have the permission to use this module.'),
                    ];
                    ...
                    $return = [
                        'success' => true,
                        'message' => 'Le module a été désactivé sur un truc avec succès',
                    ];                    
                ...
                $return = [
                    'success' => false,
                    'message' => Tools::displayError('Cannot load the module\'s object.'),
                ];                
            }
            ...
            $return = [
                'success' => false,
                'message' => Tools::displayError('You do not have permission to add this.'),
            ]; 
        }
        die(Tools::jsonEncode($return));
    }
    ...
    public function postProcessCallback() {
                ...
                foreach ($modules as $name) {
                    ...
                    if (!($module = Module::getInstanceByName(urldecode($name)))) {
                        ...
                        if (!($key === 'install' && Validate::isLoadedObject($updater) && $updater->installModule(urldecode($name)))) {
                            $this->errors[] = $this->la('Module not found');
                        }
                    ...
                    if ($key == 'update' && !Module::isInstalled($module->name)) {
                        ...
                        if ($key != 'update' && $key != 'updateAll' && $key != 'checkAndUpdate' && $key != 'delete') {
                            ...
                            if ($key == 'install' && $echo === true && strpos(Tools::getValue('install'), '|') === false && method_exists($module, 'getContent')) {
                                Tools::redirectAdmin(static::$currentIndex . '&configure=' . $module->name . '&conf=12');
                            }
                        ...
                        if ($key == 'configure' && Module::isInstalled($module->name)) {
                            ...
                            $backLink = static::$currentIndex . '&tab_module=' . $module->tab . '&module_name=' . $module->name;
                            
                            $hookLink = 'index.php?tab=AdminModulesPositions&show_modules=' . (int) $module->id;
                           
                            $tradLink = 'index.php?tab=AdminTranslations&type=modules&lang=';
                    ...
                    if ($key != 'configure' && Tools::getIsset('bpay')) {
                        Tools::redirectAdmin('index.php?tab=AdminPayment');
                    }
        ...
        if ($return) {
            ...
            if (Tools::getValue('redirect') == 'config' && Tools::getValue('module_name') != '' && $return == '12' && Module::isInstalled(pSQL(Tools::getValue('module_name')))) {
                Tools::redirectAdmin('index.php?controller=adminmodules&configure=' . Tools::getValue('module_name') . '&module_name=' . Tools::getValue('module_name') . $params);
            }

            if (isset($module)) {
                Tools::redirectAdmin(static::$currentIndex . '&conf=' . $return . '&tab_module=' . $module->tab . '&module_name=' . $module->name . '&anchor=' . ucfirst($module->name) . (isset($modulesListSave) ? '&modules_list=' . $modulesListSave : '') . $params);
            }
    ...
    public function initModal() {
        ...
        $this->context->smarty->assign(
            [
                'trad_link'        => 'index.php?tab=AdminTranslations&type=modules&lang=',
                'module_languages' => Language::getLanguages(false),
                'module_name'      => Tools::getValue('module_name'),
            ]
        );
        ...
        $this->modals[] = [
            ...
            'modal_title'   => $this->la('Translate this module'),
