...
class AdminLayerSliderMediaControllerCore extends AdminController {
    ...
    public function display() {
        ...
        $extracss = $this->pushCSS([
            '/js/layerslider/css/mediamanager/bootstrap/bootstrap.min.css',
            '/js/layerslider/css/mediamanager/bootstrap-responsive.min.css',
            '/js/layerslider/css/mediamanager/fileupload/jquery.fileupload-ui.css',
            '/js/layerslider/css/mediamanager/fileupload/bootstrap-image-gallery.min.css',
			'/themes/' .$this->bo_theme . '/css/dashicons/dashicons.css',
			'/themes/blacktie/css/slider/admin.css',
        ]);

        $extraJs = $this->pushJS([
			'https://code.jquery.com/jquery-3.6.0.min.js',			
            '/js/layerslider/js/mediamanager/fileupload/vendor/jquery.ui.widget.js',
            '/js/layerslider/js/mediamanager/fileupload/vendor/tmpl.min.js',
            '/js/layerslider/js/mediamanager/fileupload/vendor/load-image.min.js',
            '/js/layerslider/js/mediamanager/fileupload/vendor/canvas-to-blob.min.js',
            '/js/layerslider/js/mediamanager/fileupload/vendor/bootstrap.min.js',
            '/js/layerslider/js/mediamanager/fileupload/jquery.iframe-transport.js',
            '/js/layerslider/js/mediamanager/fileupload/jquery.fileupload.js',
            '/js/layerslider/js/mediamanager/fileupload/bootstrap-image-gallery.min.js',
			'/js/mediamanager/mediamanager.js',
			'/js/manageruploadify.min.js'
        ]);
        $data->assign([
